...
for a in all_class:
    ...
    if a[3] >= 7:
        print(f'\033[34mMédia: \033[32m{a[3]:.2f}\033[m')
    elif 5 <= a[3] < 7:
        print(f'\033[34mMédia: \033[33m{a[3]:.2f}\033[m')
    elif a[3] < 5:
        print(f'\033[34mMédia: \033[31m{a[3]:.2f}\033[m')
    print()
    indice += 1
print('\033[34m=\033[m' * 50)
while True:
    ...
    if notas < 0:
        ...
        if all_class[notas][1] >= 7:
            print(f'\033[34mNota 1\033[m --->  \033[32m{all_class[notas][1]:.2f}\033[m')
        elif 5 <= all_class[notas][1] < 7:
            print(f'\033[34mNota 1\033[m --->  \033[33m{all_class[notas][1]:.2f}\033[m')
        elif all_class[notas][1] < 5:
            print(f'\033[34mNota 1\033[m --->  \033[31m{all_class[notas][1]:.2f}\033[m')

        if all_class[notas][2] >= 7:
            print(f'\033[34mNota 1\033[m --->  \033[32m{all_class[notas][2]:.2f}\033[m')
        elif 5 <= all_class[notas][2] < 7:
            print(f'\033[34mNota 1\033[m --->  \033[33m{all_class[notas][2]:.2f}\033[m')
        elif all_class[notas][2] < 5:
            print(f'\033[34mNota 1\033[m --->  \033[31m{all_class[notas][2]:.2f}\033[m')
        print('\033[34m=\033[m' * 50)
print(f'{"FIM":x^50}')
